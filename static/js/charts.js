...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    var sampleFiltered = sampleArray.filter(item => item.id == sample);
    ...
    var washFreq = metadataFirst.wfreq;
    ...
    var yticks = [];
    otu_ids.slice(0,10).reverse().map(item => yticks.push('OTU' + String(item)));
